...
public class Character implements Common {
    ...
    public Character(int x, int y, int id, int direction,
        ...
        // init character
        // x , y la vi tri sinh ra character
        this.x = x;
        this.y = y;
        px = x * CS;
        py = y * CS;
        this.id = id;// id la chon hinh anh cua character trong character.gif
        this.direction = direction;// bien chi huong quay mat cua nhan vat luc xuat hien
        this.moveType = moveType;// kieu di chuyen dung yen hoac di chuyen ngau nhien tuy character
        this.map = map;
