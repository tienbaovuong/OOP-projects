...
public class MessageWindow {
    ...
    public MessageWindow(Rectangle rect) {
        ...
        messageEngine = new MessageEngine();// khoi tao va bat dau tao chu

        // load cursor image
        ImageIcon icon = new ImageIcon(getClass().getResource("image/cursor.gif"));// icon chuyen page
    ...
    public boolean nextPage() {
        ...
        if (nextFlag) {
            curPage++;
            curPos = 0;// vi tri ki tu trong 1 page
            nextFlag = false;
        }
        return false;
    }
